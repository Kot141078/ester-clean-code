...
- V “rezhime instruktora” veduschiy vyzyvaet preview/apply → plan visible i mozhet byt primenen tochechno.
...
- Skrytyy #1: (Infoteoriya ↔ Upravlenie) prozrachnye parameter (radius/penalty/min_thr).
- Skrytyy #2: (Inzheneriya ↔ Bezopasnost) primenyaetsya tolko vruchnuyu i tolko lokalno.

ZEMNOY ABZATs:
Tonkaya prosloyka: prosto reeksport vyzovov tyunera, zhurnalom upravlyaet instruktorskaya session.
