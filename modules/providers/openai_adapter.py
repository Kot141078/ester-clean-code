...
def _base_and_provider() -> (str, str):
    # prioritet yavnogo OPENAI_API_BASE; inache LM Studio
...
def send_chat(messages: List[Dict[str, str]],
    ...
    # Lyuboe nepustoe znachenie podkhodit LM Studio; dlya OpenAI nuzhen realnyy klyuch
    ...
    try:
        ...
        # folbek — «ekho», no ne ronyaem server
        last_user = ""
