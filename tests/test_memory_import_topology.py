...
def test_legacy_memory_module_supports_source_submodules(tmp_path, monkeypatch):
    ...
    for name in ["memory.decay_gc", "memory.hypothesis_store", "memory.kg_store", "memory"]:
