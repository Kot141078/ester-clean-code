...
Tsel:
- Garantirovat, what modul modules.memory.sleep_alias importiruetsya
  v realnoy structure project Ester.
- Prove it nalichie klyuchevykh funktsiy i bazovyy contract vozvrata.
...
- Skrytyy #2: (Inzheneriya ↔ Memory) — esli etot test zelenyy, sloy sna integrated korrektno.
...
# Bootstrap: addvlyaem koren project (ester-project) v sys.path.
