...
Ispolzovat pered zapisyu faylov bandla/otchetov. Tolko stdlib. Vozvraschaet normalizovannyy put ili brosaet ValueError.
...
def safe_join(base: str, rel: str) -> str:
    ...
    # zapreschaem vykhod za bazu i skrytye ssylochnye elementy
