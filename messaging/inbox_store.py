# -*- coding: utf-8 -*-
"""messaging/inbox_store.py - mini-inboxes: paydzhing + servernyy filtr po kanalu.
...
ZEMNOY ABZATs:
Mozhno bystro prolistyvat tolko Telegram or tolko WhatsApp - ne peregruzhaya brauzer tekstami iz drugogo kanala.
