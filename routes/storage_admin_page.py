...
Endpoint:
  GET /admin/storage - stranitsa (Jinja2 template: storage_admin.html)
...
- Skrytyy #2: (Sovmestimost ↔ Kontrakty) drop-in blueprint bez izmeneniya ostalnogo prilozheniya.

Zemnoy abzats:
This is “panel na dvertse shkafa”: otkryl - vidish sostoyanie polok (storadzhey), mozhesh dobavit metki,
...
@jwt_required()
def page():
    """Render the administrative page of storaj."""
