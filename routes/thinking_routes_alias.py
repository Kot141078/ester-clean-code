...
- Registratsiya proiskhodit yavno (cherez auto_reg_thinking.auto_register), po umolchaniyu ne aktivna.
...
def create_blueprint():
    """Sozdaet blueprint dlya diagnostiki. Esli Flask nedostupen — vozvraschaet None."""
    ...
    def once() -> Any:  # pragma: no cover
        ...
        # Esli thought_trace_adapter est, dopolnitelno delaem kratkiy trace_text.
