...
def api_status():
    """Returns the current imprint status."""
...
def api_verify():
    """Checks the text and hash of the imprint."""
...
def api_canon():
    """Returns the canonical text of the imprint hash."""
