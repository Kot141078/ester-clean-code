# -*- coding: utf-8 -*-
"""
Admin Judge - panel zaprosa i agregatsii otvetov.

Most (yavnyy):
- (Kibernetika ↔ UX) Polzovatel vidit chernovye otvety modeley i finalnuyu «sborku».

Mosty (skrytye):
- (Infoteoriya ↔ Ekonomika) Edinyy format vyvoda (answers[], final) snizhaet trenie na sleduyuschikh stadiyakh payplayna i zatraty na marshrutizatsiyu.
...
# Kontrakty ne menyaem: import kak v dampe
...
def api_run():
    ...
    try:
        ...
        # Drop-in povedenie: otdat oshibku JSONom, bez trassy
