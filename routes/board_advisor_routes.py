...
_HTML = """<!doctype html><html><head><meta charset="utf-8"><title>Synergy Advisor</title>
<style>
...
<div class="card">
  <label>Description zadachi:<br><textarea id="task" rows="3" style="width:100%" placeholder="nuzhen bystryy nochnoy pilot dlya FPV..."></textarea></label>
