...
ZEMNOY ABZATs:
  ...
  Kak u lyudey: vse, chto s nami proiskhodit i chto my delaem, protokoliruetsya v odnom meste, 
  no zdes bez biokhimii — prosto akkuratnyy strukturirovannyy zhurnal.
...
def _slot() -> str:
    ...
    A — osnovnoy put (ispolzuem modules.memory.events.record_event).
...
def add_event():
    ...
    # tekhniko-metadannye dlya razlichimosti A/B i istochnikov
