...
Operationally, the entity / agent hierarchy is also a temporal hierarchy: `c` holds continuity across time, while agents remain bounded runtime surfaces under it.
