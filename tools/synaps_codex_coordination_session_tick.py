"""One-shot SYNAPS Codex coordination session tick CLI."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Run one bounded SYNAPS Codex coordination session tick.")
    ...
    parser.add_argument("--ledger", default=str(DEFAULT_CODEX_COORDINATION_SESSION_TICK_LEDGER))
    ...
    parser.add_argument("--confirm", default="", help=f"Required: {CODEX_COORDINATION_SESSION_TICK_CONFIRM_PHRASE}")
    ...
    policy = CodexCoordinationSessionTickPolicy.from_env(env)
