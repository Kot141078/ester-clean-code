...
This is “pusk after obestochivaniya”: vklyuchili - i srazu meryaem, dyshit li sistema i mozhno li rabotat.

Mosty:
- Yavnyy (Arkhitektura ↔ Nadezhnost): stsenariy vykhoda/vkhoda iz stroya podtverzhdaet otkazoustoychivost payplayna.
- Skrytyy 1 (Infoteoriya ↔ Ekonomika): vtoroy zapros dolzhen idti bystree (cash) - ekonomim vychislenie.
...
def main():
    ...
    ap.add_argument("--q", default="information theory Bayes entropy")
    args = ap.parse_args()
