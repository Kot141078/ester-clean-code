#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""R3/tools/r3_index_build.py - CLI dlya postroeniya TF-IDF index po kartochkam Ester.
...
Zemnoy abzats:
Zapuskaetsya bez argumentov, stroit/perezapisyvaet indexes (JSON) v `PERSIST_DIR/reco`.
Podkhodit dlya cron/planirovschika. Only stdlib.
