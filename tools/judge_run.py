...
Finalka vybiraetsya majority/median. Logi pishutsya v ESTER/state/judge/* (only v B).
...
def main():
    ...
    ap.add_argument("--mode", choices=[MODE_LOCAL, MODE_FULL, MODE_FLEX], default=MODE_LOCAL, help="Request mode")
