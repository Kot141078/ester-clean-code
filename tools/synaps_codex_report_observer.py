"""Dry-run-first expected report observer for SYNAPS Codex reports."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Observe exactly one expected SYNAPS Codex report transfer.")
    ...
    parser.add_argument("--operator", default="codex-report-observer")
    parser.add_argument("--apply", action="store_true")
    parser.add_argument("--confirm", default="", help=f"Required for --apply: {CODEX_REPORT_OBSERVER_CONFIRM_PHRASE}")
