"""Bounded manifest selector for one expected SYNAPS Codex report."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--operator", default="codex-report-selector")
    parser.add_argument("--max-cycles", type=int, default=0)
    parser.add_argument("--sleep-sec", type=float, default=-1.0)
    parser.add_argument("--apply", action="store_true")
    parser.add_argument("--confirm", default="", help=f"Required for --apply: {CODEX_REPORT_SELECTOR_CONFIRM_PHRASE}")
