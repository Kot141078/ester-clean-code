...
Nikakikh zavisimostey, rezultat otkryvaetsya file:// lokalno.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Render staticheskoy stranitsy portala iz poslednego daydzhesta")
    ap.add_argument("--out", required=True, help="Put k vykhodnomu HTML (naprimer, portal/index.html)")
    args = ap.parse_args()
    ...
    if not p_json:
        print("WARN: net daydzhestov. Snachala soberite: r5_digest_build.py --plan ...")
        return 0
