...
- Skrytyy #1: (sys.path ↔ struktura repo) — akkuratno dobavlyaem koren proekta.
- Skrytyy #2: (operator ↔ sloy opyta) — daem prostoy kontrol kachestva nakoplennogo opyta.

ZEMNOY ABZATs:
Inzhenerno: standartnyy bootstrap sys.path + vyzov adaptera. Nikakikh syurprizov:
esli opyt nedostupen — skript chestno pechataet, chto kontekst pust.
# c=a+b
"""
