...
Zapusk:
  ...
  (ili run_ester_portable.sh/cmd, sozdannye apply_self)
...
Zemnoy abzats:
Eto «perenosnoy pult»: votknul — zapustil — vospolzovalsya, ne kasayas ustanovlennoy sistemy.
...
# Opred. kornya portable po raspolozheniyu fayla
...
def create_app() -> Flask:
    ...
    # Registriruem vse, chto dostupno
    try:
