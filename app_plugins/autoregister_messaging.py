...
def _do_register_all_plus(app: Flask) -> None:
    ...
    # Podklyuchaem sam registrator i zatem dergaem ego endpoint lokalno
    reg_plus(app)
    try:
        with app.test_request_context():
            # Importiruem v kontekste, chtoby endpointy uzhe byli
            pass
    except Exception:
        pass
...
def register(app: Flask, auto: bool | None = None) -> None:
    """
    Vklyuchit ves messaging-stek. Bezopasno vyzyvat mnogokratno.
    Esli auto=True ili ESTER_AUTOREGISTER_MESSAGING=1 — registriruet khuk, kotoryy vypolnit podklyuchenie na pervom zaprose.
    """
